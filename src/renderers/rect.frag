...
layout(location = 3) in float in_border_size;
layout(location = 4) in float in_radius;
layout(location = 5) in float in_rect_aspect;
layout(location = 6) in float in_pixel_size;
